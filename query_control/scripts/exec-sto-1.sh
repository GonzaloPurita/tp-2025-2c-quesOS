...
CMD1="./../bin/query_control ../configs/query.config STORAGE_1 0"
CMD2="./../bin/query_control ../configs/query.config STORAGE_2 2"
CMD3="./../bin/query_control ../configs/query.config STORAGE_3 4"
CMD4="./../bin/query_control ../configs/query.config STORAGE_4 6"
