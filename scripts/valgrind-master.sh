...
echo "MASTER con VALGRIND"
echo "=========================================="
echo "El log de valgrind se guardará en: $VALGRIND_LOGS_DIR/master-est_${TIMESTAMP}.log"
echo ""
...
echo "Master corriendo con VALGRIND"
echo "=========================================="
echo ""
echo "Para ver los resultados después de finalizar:"
echo "  cat $VALGRIND_LOGS_DIR/master-est_${TIMESTAMP}.log | grep 'LEAK SUMMARY' -A 10"
echo "  cat $VALGRIND_LOGS_DIR/master-est_${TIMESTAMP}.log | grep 'ERROR SUMMARY'"
echo ""
